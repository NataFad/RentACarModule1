...
public class DBConnectionPoolOld {
    ...
    private volatile static DBConnectionPoolOld instance;
    private String URL;
    private String user;
     ...
     * @return
     */
    public static DBConnectionPoolOld getInstance() {
    	if (instance == null) {
			synchronized (DBConnectionPoolOld.class) {
				if (instance == null) {
					instance = new DBConnectionPoolOld();
				}
			}
		}
		return instance;
