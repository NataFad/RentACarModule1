    ...
    <tr>
        <td valign="top">
            ...
            <table width="100%" height="500" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    ...
                    <td valign="top" width="85%">
                        <!-- Личные данные -->
                        <s:form action="registration" modelAttribute="userReg" method="post">
                            <input type="hidden" name="command" value="registration"/>
                            <fieldset>
                                <legend>Личные данные</legend>
                                <label>Фамилия:&nbsp;
                                    <input type="text" name="surname" id="surname" size="25" maxlength="25"
                                           placeholder="Фамилия"
                                           pattern="^[А-ЯЁA-Z][а-яёa-z]{1,25}" required/></label><br/>
                                <label>Имя:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="text" name="name" id="name" size="25" placeholder="Имя"
                                           pattern="^[А-ЯЁA-Z][а-яёa-z]{1,20}" required/></label><br/>

                                <!-- Паспортные данные -->
                                <fieldset>
                                    <legend>Паспортные данные</legend>
                                    <label>Серия и номер:&nbsp;&nbsp;&nbsp;
                                        <input type="text" name="passportNumber" id="passportNumber" size="20"
                                               maxlength="9" placeholder="Серия и номер паспорта"
                                    ...
                                    <label>Кем выдан:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="text" name="passportAuthority" id="passportAuthority" size="50"
                                               minlength="1" maxlength="45" placeholder="Кем выдан"></label>
                                </fieldset>

                                <!-- Дата рождения -->
                                <fieldset>
                                    <legend>Дата рождения</legend>
                                    <label>Дата рождения:&nbsp;<input type="date" name="birthday" min="1950-01-01"
                                                                      required></label>
                                </fieldset>
                                ...
                                <fieldset>
                                    ...
                                    <label>Логин:&nbsp;&nbsp;&nbsp;
                                        <input type="text" name="login" id="login" size="30" maxlength="20"
                                               placeholder="Логин" pattern="[A-Za-z]{5,20}" value=""
                                               required></label><br>
                                    <label>Пароль:&nbsp;&nbsp;
                                        <input type="Password" name="password" id="password" size="30" maxlength="20"
                                               placeholder="Пароль" pattern="[A-Za-z]{5,20}"
                                ...
                                <fieldset>
                                    ...
                                    <label>E-mail:&nbsp;
                                        <input type="email" name="email" id="email" placeholder="Введите адрес почты"
                                               autocomplete="on" required></label><br>
                                    <label>Телефонный номер в формате +ХХХ&ndash;ХХ&ndash;ХХХ&ndash;ХХ&ndash;ХХ:&nbsp;
                                        <input type="text" name="phone" size="20" maxlength="17"
            ...
            <table width="100%" height="90" bgcolor="#38b2ce" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td>
                        <%@include file="../elements/_footer.jsp" %>
                    </td>
                </tr>
            </table>
            <!-- конец "подвала"  №4-->
